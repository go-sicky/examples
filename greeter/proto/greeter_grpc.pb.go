...
const (
	Greeter_Hello_FullMethodName     = "/greeter.examples.sicky.dev.Greeter/Hello"
	Greeter_Timestamp_FullMethodName = "/greeter.examples.sicky.dev.Greeter/Timestamp"
)
...
type GreeterClient interface {
	...
	Timestamp(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TimestampResponse, error)
}
...
func (c *greeterClient) Timestamp(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TimestampResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TimestampResponse)
	err := c.cc.Invoke(ctx, Greeter_Timestamp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	Timestamp(context.Context, *emptypb.Empty) (*TimestampResponse, error)
...
func (UnimplementedGreeterServer) Timestamp(context.Context, *emptypb.Empty) (*TimestampResponse, error) {
...
func _Greeter_Timestamp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_Timestamp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Timestamp(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "greeter.examples.sicky.dev.Greeter",
