module github.com/go-sicky/examples/bff

go 1.22.5

require (
	github.com/go-sicky/examples/cfilter v0.0.0-20231211042812-632822a29d12
	github.com/go-sicky/sicky v0.0.0-20240718081258-564a80ed440b
